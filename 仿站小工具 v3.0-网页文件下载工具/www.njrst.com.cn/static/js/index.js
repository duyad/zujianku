$(function(){  
	var defaults = {
  	...
  	var opts;
   	...
   	$(".top ul li").click(function(){
        var index1 = $(".top ul li").index(this);
 		console.log(index1);
        iIndex=index1;
  ...
  //重置鼠标滚轮事件
    ...
    $("#next_btn").click(function(){
  	...
  	$(".s1_con .s1_con_wb li").mouseover(function(event) {
  		var conwb = $(".s1_con .s1_con_wb li").index(this);
  		console.log(conwb);
  		$(".phone ul li").eq(conwb).css({"width": '280px'}).siblings("li").css({"width": '0px'});
  	});
  	$(".lc_con ul li").mouseover(function(event){
  		var conlc = $(".lc_con ul li").index(this);
  		$(".miaoshu p").eq(conlc).css({"color":'#f8f8f8'}).siblings("p").css({"color":'transparent'});
  	});
}); 